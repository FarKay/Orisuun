...
function App() {
  return (
    <div className="mx-auto my-0 flex h-screen w-[1440px] flex-col gap-[229px] bg-[#FFFFFF] font-sans">
      <div className="flex flex-col gap-[150px]">
        <section className="h-[820px] bg-custom-image bg-cover bg-no-repeat text-[#FFFFFF]">
          <div className="mb-[30px] h-[148.64px] bg-custom-gradient">
        ...
        <section className="flex flex-col items-center p-[30px]">
          ...
          <div className="mb-5 flex flex-row items-center justify-center gap-[8px] rounded-[66px] bg-[#F8F8F8] p-1">
            <div className="flex items-center justify-center">
              <button className="rounded-[59px] bg-[#FFFFFF] px-20 py-4 text-[18px] font-semibold leading-[24px]">
                Growth
              </button>
            </div>
            <div className="flex items-center justify-center">
              <button className="px-[8px] text-[18px] font-medium leading-[24px]">
          ...
          <div className="mx-auto my-10 flex flex-row gap-[72px]">
            <div className="flex h-[154px] w-[123px] flex-col items-center bg-custom-gradient-card">
            ...
            <div className="flex h-[154px] w-[116px] flex-col items-center bg-custom-gradient-card-2">
              <div className="-z-10 mb-3">
        ...
        <section className="m-auto flex flex-col gap-[40px] p-[100px]">
          <h1 className="mb-5 text-center text-[40px] font-semibold leading-[44px] text-[#001E5F]">
            Exceptioanlly Affordable
          </h1>

          <div className="flex flex-row items-center justify-between rounded-[66px] bg-[#F8F8F8] p-1">
            <div>
              <button className="rounded-[59px] bg-[#FFFFFF] px-12 py-4 text-[20px] font-semibold leading-[24px] text-[#1B3C7B]">
                Monthly
              </button>
            </div>
            <div className="flex flex-col items-center justify-center px-12">
              <span className="text-[20px] font-medium leading-[24px] text-[#808181]">
                Quarterly
              </span>
      ...
      <footer className="mx-[45px] flex flex-col px-[20px]">
